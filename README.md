...
Requires [AKtools](https://github.com/f-brinkmann/AKtools) (unless you already have an RIR dataset).

## Active Acoustics Review Simulations Branch
The [```review-simulations```](https://github.com/wjcassidy/AAESToolbox/blob/review-simulations/Active%20Acoustics%20Review/README.md) branch provides scripts and audio examples to recreate the simulations from the review article [Active acoustic enhancement systems: A review](https://pubs.aip.org/asa/jasa/article/159/4/3533/3387630/Active-acoustic-enhancement-systems-A-review). See the [README](https://github.com/wjcassidy/AAESToolbox/blob/review-simulations/Active%20Acoustics%20Review/README.md) for more information.
