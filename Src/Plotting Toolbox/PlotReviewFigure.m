...
% Use this method to plot the main components of the figures from the paper
% "Active Acoustic Enhancement Systems - A Review". Before running, the
% AAES RIRs need generating using the workflow detailed in the README:
% https://github.com/wjcassidy/AAESToolbox/blob/review-simulations/Active%20Acoustics%20Review/README.md
...
function PlotReviewFigure(figure_number)
    close all
    ...
    elseif figure_number == 13
        ...
        error("Please specify a figure number between 7 and 13.");
    end
end
